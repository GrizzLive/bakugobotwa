...
/////////////////
const BotName = 'Bakugo_BOT'; 
const instagram = 'https://www.instagram.com/revlobain_aja/'; 
const telegram = 'Belum Ada'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/channel/UCW7gNuz1j3u9uZDgUk1_6LQ';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@revlobain_aja')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@revlobain_aja`)
})
